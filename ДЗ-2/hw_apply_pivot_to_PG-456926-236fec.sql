--1. Установите расширение "tablefunc" в PostgreSQL из пакета "postgresql-contrib"


--2. Перепишите весь скрипт на plpgsql с использованием функции CROSSTAB вместо PIVOT из расширения "tablefunc"
